...
import 'package:flutter_smart_office_project/page/table_detail_page.dart';
...
class TableDisplay extends StatefulWidget {
  const TableDisplay({Key? key}) : super(key: key);
...
class _TableDisplayState extends State<TableDisplay> {
  ...
  Future<int> connect() async {
    ...
    const topic1 = 'student/CASA0022/ucfnmz0/IR1'; // Not a wildcard topic
    const topic2 = 'student/CASA0022/ucfnmz0/IR2'; // Not a wildcard topic
    const topic3 = 'student/CASA0022/ucfnmz0/IR3'; // Not a wildcard topic
    ...
    const pubTopic = 'student/CASA0022/ucfnmz0/requesttopic/tableRequest';
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text(
                    'Press the button to fetch Table status',
                ...
                Column(
                  ...
                  children: <Widget>[
                    IconButton(
                      iconSize: 70,
                      icon: _ta1 == 'on'
                          ? Icon(Icons.table_restaurant_rounded, color: Color(0xffE09E45))
                          : Icon(Icons.table_restaurant_outlined,
                          color: Color(0xff496571)),
                      tooltip: 'Table 01 detail info',
                      onPressed: () {
                        setState(() {
